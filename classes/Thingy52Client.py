...
class Thingy52Client(BleakClient):
    ...
    async def disconnect(self) -> bool:
        ...
        try:
            print(f"Disconnected to {self.mac_address}")
            return True
        except Exception as e:
            print(f"Failed to disconnect to {self.mac_address}")
            return False
    ...
    async def receive_inertial_data(self, sampling_frequency: int = 60):
        ...
        #a+ aggiungi le cose, append e se il file non è presente si crea
    ...
    def save_to(self, file_name):
        ...
        #metto self che è il termina della classe e poi il nome dell'azione, crea file .csv
